...
`FRAME #1009` · 2026-08-26 18:51 UTC
...
▁ company · 1 turns · 6 min   (frames #1008 → #1009)
```

| | |
|---|---:|
| Turns elapsed on this turn | **1** |
| Held for | 6 min |
...
<sub>Rendered from the repo at frame #1009 · immediate mode, no client state</sub>
